...
public class MyMarker extends FrameLayout
{
    ...
    private OnClickListener onclic;
    ...
    private void initView() {
        ...
        textView_670.post(() -> imageView_948.post(() -> setPadding(0,0,0,(textView_670.getHeight()/2)+(imageView_948.getHeight()*2))));
        linearLayout_721.setOnTouchListener((p1, p2) -> {
            switch(p2.getAction()){
        ...
        linearLayout_721.setOnClickListener(p1 -> {
