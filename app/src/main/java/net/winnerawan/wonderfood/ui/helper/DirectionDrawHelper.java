...
public class DirectionDrawHelper {
	...
	private OnNavigateReadyListener callback;
	...
	public DirectionDrawHelper(Context ctx, GoogleMap map, LatLng start, LatLng end, VMargin v) {
		...
		Log.d("lok", "dest:" + end + "---start:" + start);
 	}
	public void start() {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i=0;i < result.size();i++) {
				...
				anim=MapAnimator.getInstance();
 				Utils.requestCenterCamera(ctx, map, addr_start, addr_end, vmargin, () -> anim.animateRoute(map, points));
            }
