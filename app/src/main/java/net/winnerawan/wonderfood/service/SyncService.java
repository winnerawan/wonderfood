package net.winnerawan.wonderfood.service;
...
import net.winnerawan.wonderfood.di.component.DaggerServiceComponent;
import net.winnerawan.wonderfood.di.component.ServiceComponent;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        ServiceComponent component = DaggerServiceComponent.builder()
                .applicationComponent(((Wonderfood) getApplication()).getComponent())
                .build();
