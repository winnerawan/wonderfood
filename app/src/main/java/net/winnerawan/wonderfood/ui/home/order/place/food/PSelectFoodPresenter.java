 ...
 */
public class PSelectFoodPresenter<V extends PSelectFoodView> extends BasePresenter<V> implements PSelectFoodMvpPresenter<V> {

    @Inject
    public PSelectFoodPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable) {
