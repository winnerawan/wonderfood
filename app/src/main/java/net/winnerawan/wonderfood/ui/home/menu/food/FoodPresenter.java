 ...
 */
public class FoodPresenter<V extends FoodView> extends BasePresenter<V> implements FoodMvpPresenter<V> {

    @Inject
    public FoodPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable) {
