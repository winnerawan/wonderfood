package net.winnerawan.wonderfood.ui.home.order.place.food;
 ...
 */
public class PSelectFoodFragment extends BaseFragment implements PSelectFoodView, PSelectFoodAdapter.Callback, NumberPickerDialogFragment.NumberPickerDialogHandlerV2 {

    private static final String TAG = "PSelectFoodFragment";
    @Inject
    PSelectFoodMvpPresenter<PSelectFoodView> mPresenter;
    ...
    public static PSelectFoodFragment newInstance() {
        Bundle args = new Bundle();
        PSelectFoodFragment fragment = new PSelectFoodFragment();
    ...
    public void showDialog() {
        NumberPickerBuilder npb = new NumberPickerBuilder()
                ...
                .setTargetFragment(PSelectFoodFragment.this)
